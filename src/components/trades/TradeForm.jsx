    ...
    <div style={{ background: T.surface, border: `1px solid ${accentColor}66`, borderRadius: 14, padding: 24, boxShadow: "0 8px 32px rgba(0,0,0,0.1)" }}>
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          <ImageUpload label="Antes — Análisis" icon={BarChart3} value={form.imgBefore} onChange={v => setForm(p => ({ ...p, imgBefore: v }))} accentColor={accentColor} />
          <ImageUpload label="Después — Resultado" icon={Camera} value={form.imgAfter} onChange={v => setForm(p => ({ ...p, imgAfter: v }))} accentColor={accentColor} />
        </div>
      </div>
